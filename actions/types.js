...
export const START_ADD_SERVICE = 'start_add_service'
...
export const SEARCH_RESULT_CITIES = 'search_result_cities'
export const SEARCH_RESULT_NAMES = 'search_result_names'
export const SELECT_STORE = 'select_store'
export const LOADING_STORE = 'loading_store'
export const LOAD_STORE_SERVICES = 'load_store_services'
